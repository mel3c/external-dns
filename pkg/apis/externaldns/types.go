...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("managed-record-types", "Record types to manage; specify multiple times to include many; (default: A, AAAA, CNAME, NS) (supported records: A, AAAA, CNAME, NS, SRV, TXT)").Default("A", "AAAA", "CNAME", "NS").StringsVar(&cfg.ManagedDNSRecordTypes)
